...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: pageMeta({ title: "Privacy Policy — Cheapest Towing 2013 NZ", description: "How Cheapest Towing 2013 NZ collects, uses and protects your personal information.", path: "/privacy-policy" }),
  ...
  return (
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 py-16 text-muted-foreground space-y-4">
        <p>We respect your privacy. This policy explains what data we collect when you contact Cheapest Towing 2013 NZ and how we use it.</p>
        ...
        <p>In accordance with New Zealand's Privacy Act 2020, you may request access to, correction of, or deletion of your personal data at any time by contacting us.</p>
      </article>
    </SiteLayout>
  );
}