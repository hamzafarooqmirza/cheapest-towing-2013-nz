...
function About() {
  return (
    <SiteLayout>
      <PageHero eyebrow="About Us" title="Built on trust, driven by service" subtitle="Cheapest Towing 2013 NZ is a family-run NZ company built on punctuality, transparency and care for every vehicle we handle." image={IMG.roadsideAssistance} />
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-16 grid gap-10 lg:grid-cols-2 items-center">
        <div className="overflow-hidden rounded-3xl border border-border shadow-2xl">
          <img src={IMG.carTowing} alt="Cheapest Towing 2013 NZ tow truck recovering a classic car" className="h-full w-full object-cover aspect-[4/3]" />
        </div>
        <div>
          <h2 className="text-3xl md:text-4xl font-black">Our Story</h2>
          <p className="mt-4 text-muted-foreground">What started as a single tow truck has grown into a fully-equipped fleet serving drivers across Auckland and beyond. We've recovered everything from family hatchbacks to rare classics, and we treat every job with the same level of professionalism.</p>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-10 grid gap-6 md:grid-cols-3">
        {[
          { t: "Our Mission", d: "Deliver fast, honest, professional roadside help to every driver in NZ." },
