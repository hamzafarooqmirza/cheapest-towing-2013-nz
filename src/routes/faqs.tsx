...
export const Route = createFileRoute("/faqs")({
  head: () => ({
    meta: pageMeta({ title: "FAQs — Cheapest Towing 2013 NZ", description: "Answers to common questions about our roadside assistance, recovery and storage services.", path: "/faqs", image: IMG.roadsideAssistance }),
